...
################# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/data2/lwy/projevt/Lung/VGG_egfr9_1_Dialated_AC_in_Dense_K_fold/output_173_90_112_112/12_13_nopretrained_32_noDialated_Tran_Dialated_AC_in_DenseNet9_(CT2_second_hu_0_255)_(utils_acc_auc)_5fold_bs4_1', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--manualSeed', type=int, help='manual seed')
################# Transformer
parser.add_argument('--stand_dim', default=32, type=int, metavar='N',
