...
from lib import dataset_new_CT_twodataset as dataset
...
################# Datasets
parser.add_argument('--data1', default='/disk1/liuzy/dataset/guizhou_dataset/all_new/Dataset_112_112_112/CT/dataset1_second_hu/0_255', type=str)
parser.add_argument('--data2', default='/disk1/liuzy/dataset/guizhou_dataset/NSCLC/Dataset_112_112_112/CT/dataset2_second_hu', type=str)
...
################# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/disk1/liuzy/lung_cancer_project/VGG_egfr9_1_Dialated_AC_in_Dense_K_fold/output_ablation/Dialated_AC_in_DenseNet9_(112_guizhou_nsclc_CT_second_hu_0_255)_(utils_acc_auc)_5fold_bs4_1', type=str, metavar='PATH',
...
def train_val(model, train_loader1, test_loader1, fold_index):
    ...
    for epoch in range(0, args.epochs):
        ...
        test_loss, test_acc, test_auc, test_gt_list_array, test_pred_list_array = utils.test(test_loader1, model, criterion, use_cuda, args.train_batch)
...
def initialize_datasets():
    ...
    train_loader4, test_loader4, train_loader5, test_loader5 = dataset.loaderloader(args.data1, args.data2, args.train_batch)
