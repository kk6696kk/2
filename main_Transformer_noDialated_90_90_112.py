...
from lib import dataset_new_CT_90_90_112 as dataset
...
parser.add_argument('-cuda', default='8', type=str, metavar='N',
...
################# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/data2/lwy/projevt/Lung/VGG_egfr9_1_Dialated_AC_in_Dense_K_fold/output_173_90_112_112/test90_90_112_BS6_6_30_nopretrained_96_noDialated_Tran_Dialated_AC_in_DenseNet9_(CT2_second_hu_0_255)_(utils_acc_auc)_5fold_bs4_1', type=str, metavar='PATH',
