...
################# Datasets
parser.add_argument('--data1', default='/disk1/liuzy/dataset/guizhou_dataset/all_new/Dataset/CT/dataset2_second_hu/0_255', type=str)
parser.add_argument('--data2', default='/disk1/liuzy/dataset/guizhou_dataset/NSCLC/Dataset/CT/dataset2_second_hu', type=str)
...
################# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/disk1/liuzy/lung_cancer_project/VGG_egfr9_1_Dialated_AC_in_Dense_K_fold/output_ablation/Dialated_AC_in_DenseNet9_(90_guizhou_nsclc_CT_second_hu_0_255)_(utils_acc_auc)_5fold_bs6_1', type=str, metavar='PATH',
