...
################# Datasets
parser.add_argument('-d', '--data', default='/data2/lwy/dataset/New_CT_dataset/Dataset_112_112_112/CT/dataset1_second_hu/0_255', type=str)
...
################# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/data2/lwy/projevt/Lung/VGG_egfr9_1_Dialated_AC_in_Dense_K_fold/output_173_90_112_112/test112_7_22_nopretrained_layer2_96_noDialated_Tran_Dialated_AC_in_DenseNet9_(CT2_second_hu_0_255)_(utils_acc_auc)_5fold_bs4_1', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--manualSeed', type=int, help='manual seed')
################# Transformer
parser.add_argument('--stand_dim', default=96, type=int, metavar='N',
                    help='the word size of the transformer')
parser.add_argument('--transformer_layers', default=2, type=int, metavar='N',
