...
parser.add_argument('-cuda', default='6', type=str, metavar='N',
...
parser.add_argument('--train_batch', default=4, type=int, metavar='N',     # 6
                    help='train batchsize (default: 256)')
parser.add_argument('--test_batch', default=4, type=int, metavar='N',      # 6
...
################# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/data2/lwy/projevt/Lung/VGG_egfr9_1_Dialated_AC_in_Dense_K_fold/output_173_90_112_112/12_13_nopretrained_512_noDialated_Tran_Dialated_AC_in_DenseNet9_(CT2_second_hu_0_255)_(utils_acc_auc)_5fold_bs4_1', type=str, metavar='PATH',
