...
class D2Net(nn.Module):
    ...
    def __init__(self, inchannels):
        ...
        # 1
        self.ac1 = nn.Sequential(AC_layer(inchannels, inchannels),
        ...
        # 2
        self.ac2 = nn.Sequential(AC_layer(inchannels * 2, inchannels * 2),
                                 nn.BatchNorm3d(inchannels * 2),
                                 nn.ELU())
        ...
        # 3
        self.ac3 = nn.Sequential(AC_layer(inchannels * 3, inchannels * 3),
                                 nn.BatchNorm3d(inchannels * 3),
                                 nn.ELU())
...
if __name__=='__main__':
    ...
    datas = []
    data1 = torch.rand(1, 1, 90, 112, 112)
    datas.append(data1)
    for data in datas:
        print(data.size())
        output = model(data)
