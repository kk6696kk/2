...
class DenseNet_112_112_112(nn.Module):
    def __init__(self, nb_filter=8, nb_block=4,
                 num_classes=2,
                 stand_dim=128,
                 transformer_layers=1,
        ...
        super(DenseNet_112_112_112, self).__init__()
        ...
        # networks
        # self.to_stand_feature_0 = nn.Linear(8*80*102*102, self.stand_dim)
        self.to_stand_feature_1 = nn.Linear(24*26*26*26, self.stand_dim)
        self.to_stand_feature_2 = nn.Linear(72*13*13*13, self.stand_dim)
        self.to_stand_feature_3 = nn.Linear(216*6*6*6, self.stand_dim)
        self.to_stand_feature_4 = nn.Linear(648, self.stand_dim)
        self.to_stand_feature_5 = nn.Linear(num_classes, self.stand_dim)
        self.FC = nn.Linear(5 * stand_dim, num_classes)  # 4:layers+1
        self.sigmoid = nn.Sigmoid()
    ...
    def forward(self, x):  # [4, 1, 80, 112, 112]
        ...
        # flatten the feature to B*(C*H*W)  self.AVGpool
        # feature_0 = torch.flatten(feature_0, 1)              # [4, 8, 80, 102, 102]
        feature_1 = torch.flatten(self.maxpool(feature_1), 1)                # torch.Size([6, 24, 51, 51, 51])
        feature_2 = torch.flatten(self.maxpool(feature_2), 1)                # torch.Size([6, 72, 25, 25, 25])
        feature_3 = torch.flatten(self.maxpool(feature_3), 1)                # torch.Size([6, 216, 12, 12, 12])
        feature_4 = torch.flatten(feature_4, 1)                # torch.Size([6, 648])
        feature_5 = torch.flatten(feature_5, 1)                # torch.Size([6, 2])
...
class DenseNet_90_90_90(nn.Module):
    def __init__(self, nb_filter=8, nb_block=4,
                 num_classes=2,
                 stand_dim=128,
                 transformer_layers=1,
        ...
        super(DenseNet_90_90_90, self).__init__()
        ...
        # networks
        # self.to_stand_feature_0 = nn.Linear(8*80*102*102, self.stand_dim)
        self.to_stand_feature_1 = nn.Linear(24*20*20*20, self.stand_dim)
        self.to_stand_feature_2 = nn.Linear(72*10*10*10, self.stand_dim)
        self.to_stand_feature_3 = nn.Linear(216*5*5*5, self.stand_dim)
        self.to_stand_feature_4 = nn.Linear(648, self.stand_dim)
        self.to_stand_feature_5 = nn.Linear(num_classes, self.stand_dim)
        self.FC = nn.Linear(5 * stand_dim, num_classes)  # 4:layers+1
        self.sigmoid = nn.Sigmoid()
    ...
    def forward(self, x):  # [4, 1, 80, 112, 112]
        ...
        # flatten the feature to B*(C*H*W)  self.AVGpool
        # feature_0 = torch.flatten(feature_0, 1)              # [4, 8, 80, 102, 102]
        feature_1 = torch.flatten(self.maxpool(feature_1), 1)                # torch.Size([6, 24, 20, 20, 20])
        feature_2 = torch.flatten(self.maxpool(feature_2), 1)                # torch.Size([6, 72, 10, 10, 10])
        feature_3 = torch.flatten(self.maxpool(feature_3), 1)                # torch.Size([6, 216, 5, 5, 5])
        feature_4 = torch.flatten(feature_4, 1)                # torch.Size([6, 648])
        feature_5 = torch.flatten(feature_5, 1)                # torch.Size([6, 2])
...
class DenseNet_112_90_90(nn.Module):
    def __init__(self, nb_filter=8, nb_block=4,
                 num_classes=2,
                 stand_dim=128,
                 transformer_layers=1,
        ...
        super(DenseNet_112_90_90, self).__init__()
        ...
        # networks
        # self.to_stand_feature_0 = nn.Linear(8*80*102*102, self.stand_dim)
        self.to_stand_feature_1 = nn.Linear(24*20*20*26, self.stand_dim)
        self.to_stand_feature_2 = nn.Linear(72*10*10*13, self.stand_dim)
        self.to_stand_feature_3 = nn.Linear(216*5*5*6, self.stand_dim)
        self.to_stand_feature_4 = nn.Linear(648, self.stand_dim)
        self.to_stand_feature_5 = nn.Linear(num_classes, self.stand_dim)
        self.FC = nn.Linear(5 * stand_dim, num_classes)  # 4:layers+1
        self.sigmoid = nn.Sigmoid()
...
if __name__=='__main__':
    ...
    datas = []
    data1 = torch.rand(6, 1, 112, 90, 90)
    datas.append(data1)
    for data in datas:
        print(data.size())
        output = model(data)
