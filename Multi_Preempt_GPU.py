...
# trainpythonfile ='/data2/lwy/projevt/Lung/VGG_egfr9_1_Dialated_AC_in_Dense_K_fold/main_Transformer_noDialated_parameter_embedding256.py'
trainpythonfile = '/data2/lwy/projevt/Lung/VGG_egfr9_1_Dialated_AC_in_Dense_K_fold/main_Transformer_noDialated_112_112_112.py'

gpu_memory = 7 # 预期GPU剩余显存，如果达到这个数字就运行train脚本
